...
<head>
	...
	<meta charset="utf-8">
	<title> Martin's Food Hub | Products </title>
...
<body>
	...
	<div class="header" >
		...
		<div class="inner_header" >
			...
			<ul class="navigation"> 
				<li><a href="index.php" style="text-decoration: none;"><i class="fas fa-home"></i>Home</a></li>
				<li class="active"><a href="Products.php" style="text-decoration: none;"><i class="fas fa-ballot"></i>Products</a></li>
